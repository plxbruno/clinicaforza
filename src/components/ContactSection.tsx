    ...
    <section id="contato" className="py-20 md:py-44">
      <div className="max-w-4xl mx-auto px-6 text-center flex flex-col items-center gap-8">
        ...
        <a
          ...
          className="inline-flex items-center gap-4 bg-[#25D366] text-white font-semibold text-lg px-10 py-5 rounded-full hover:opacity-90 hover:scale-105 transition-all duration-200 shadow-xl shadow-black/20 mt-2"
        >
        ...
        <Reveal delay={360} className="mt-6 pt-8 border-t border-white/10 w-full">
          ...
          <a
            href="https://instagram.com/drbrunogaldino"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 text-white/50 hover:text-white transition-colors text-sm"
          >
